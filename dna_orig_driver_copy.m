...
%%%%%%%%%%%%%%%%%%%%%%
% INITIAL CONDITION
Y0 = [0;0]; %not sure what to make these
%%%%%%%%%%%%%%%%%%%%%%
...
p = [0.015,0.0075,0.09375,0.1875,3.25,0.001,0.05]
k1=p(1);
k2=p(2);
k3=p(3);
k4=p(4);
kp = p(5);
Kmp = p(6);
k2_ = p(7); %meant to represent k2' but we cannot use apostrophes in var names
